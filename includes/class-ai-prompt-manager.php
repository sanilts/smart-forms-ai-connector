    ...
    public function render_prompt_settings_meta_box($post) {
        ...
        <table class="form-table">
            <tr>
                ...
                <td>
                    <textarea name="sfaic_system_prompt" id="sfaic_system_prompt" class="large-text code" rows="40"><?php echo esc_textarea($system_prompt); ?></textarea>
            ...
            <tr id="template-row" <?php echo ($prompt_type != 'template') ? 'style="display:none;"' : ''; ?>>
                ...
                <td>
                    <textarea name="sfaic_user_prompt_template" id="sfaic_user_prompt_template" class="large-text code" rows="40"><?php echo esc_textarea($user_prompt_template); ?></textarea>
                    <p class="description">
